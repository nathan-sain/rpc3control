...
#telnet into unit and turn on oulet
...
#if status file exists, read it and  update timestamp and outlet status for the turned on outlet. Also mark the file with updated status flag.
if (fileexists):
